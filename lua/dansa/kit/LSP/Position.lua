...
---@param encoding? dansa.kit.LSP.PositionEncodingKind
...
---@param bufnr integer
---@param position dansa.kit.LSP.Position
...
---@param position dansa.kit.LSP.Position
---@param from_encoding dansa.kit.LSP.PositionEncodingKind
---@param to_encoding dansa.kit.LSP.PositionEncodingKind
