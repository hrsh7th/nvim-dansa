...
---@alias dansa.kit.Vim.FloatingWindow.WindowKind 'main' | 'scrollbar_track' | 'scrollbar_thumb'

---@class dansa.kit.Vim.FloatingWindow.BorderSize
...
---@class dansa.kit.Vim.FloatingWindow.ContentSize
---@field public width integer
---@field public height integer

---@class dansa.kit.Vim.FloatingWindow.WindowConfig
...
---@class dansa.kit.Vim.FloatingWindow.Viewport
...
---@field public border_size dansa.kit.Vim.FloatingWindow.BorderSize
---@field public content_size dansa.kit.Vim.FloatingWindow.ContentSize
...
---@class dansa.kit.Vim.FloatingWindow.Config
---@field public markdown? boolean

---@class dansa.kit.Vim.FloatingWindow
---@field private _augroup string
---@field private _config dansa.kit.Vim.FloatingWindow.Config
...
---@param win? integer
---@param buf integer
---@param win_config dansa.kit.Vim.FloatingWindow.WindowConfig
---@return integer
...
---@return dansa.kit.Vim.FloatingWindow.BorderSize
...
---@return dansa.kit.Vim.FloatingWindow.ContentSize
...
---@param params { border_size: dansa.kit.Vim.FloatingWindow.BorderSize, content_size: dansa.kit.Vim.FloatingWindow.ContentSize, max_outer_width: integer, max_outer_height: integer }
...
---Create window.
---@return dansa.kit.Vim.FloatingWindow
function FloatingWindow.new()
  return setmetatable({
    _augroup = vim.api.nvim_create_augroup(('dansa.kit.Vim.FloatingWindow:%s'):format(kit.unique_id()), {
      clear = true,
    }),
    _config = {
      markdown = false,
...
---Get config.
---@return dansa.kit.Vim.FloatingWindow.Config
function FloatingWindow:get_config()
  return self._config
end

---Set config.
---@param config dansa.kit.Vim.FloatingWindow.Config
...
---@param key string
---@param value any
---@param kind? dansa.kit.Vim.FloatingWindow.WindowKind
...
---@return dansa.kit.Vim.FloatingWindow.Viewport
