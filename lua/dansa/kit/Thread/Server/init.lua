...
local Session = require('dansa.kit.Thread.Server.Session')
...
---@class dansa.kit.Thread.Server
---@field private stdin uv.uv_pipe_t
---@field private stdout uv.uv_pipe_t
---@field private stderr uv.uv_pipe_t
---@field private dispatcher fun(session: dansa.kit.Thread.Server.Session): nil
---@field private process? uv.uv_process_t
---@field private session? dansa.kit.Thread.Server.Session
local Server = {}
Server.__index = Server

---Create new server instance.
---@param dispatcher fun(session: dansa.kit.Thread.Server.Session): nil
---@return dansa.kit.Thread.Server
