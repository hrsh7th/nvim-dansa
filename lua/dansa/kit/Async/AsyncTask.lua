...
---@class dansa.kit.Async.AsyncTask
---@field private value any
---@field private status dansa.kit.Async.AsyncTask.Status
...
---@param task dansa.kit.Async.AsyncTask
---@param status dansa.kit.Async.AsyncTask.Status
---@param value any
...
---@enum dansa.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: dansa.kit.Async.AsyncTask.Status, value: any }
