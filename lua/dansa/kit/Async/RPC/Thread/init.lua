...
local Session = require('dansa.kit.Async.RPC.Session')

---@class dansa.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session dansa.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: dansa.kit.Async.RPC.Session)
